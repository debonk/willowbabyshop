...
class ControllerModulePavnewsletter extends Controller {
	...
	public function initData(){
		...
		$menus["draft_contact"] = array("link"=>$this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'], 'SSL'),"title"=>$this->language->get('menu_draft_contact'));
		$menus["contact"] = array("link"=>$this->url->link('module/pavnewsletter/contact', 'token=' . $this->session->data['token'], 'SSL'),"title"=>$this->language->get('menu_contact'));
	...
	public function draft_contact(){
		...
		$this->mdata['url_delete'] = $this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			if ( isset($this->request->post['selected']) ) {
				...
				$this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'], 'SSL'));
			}
		}
		...
		foreach ($results as $result) {
			$this->mdata['drafts'][] = array(
				...
				'edit'       => $this->url->link('module/pavnewsletter/contact', 'token=' . $this->session->data['token'] . '&draft_id=' . $result['draft_id'] . $url, 'SSL'),
				'delete'     => $this->url->link('module/pavnewsletter/draft_contact/delete', 'token=' . $this->session->data['token'] . '&draft_id=' . $result['draft_id'] . $url, 'SSL')
			);
		}
		...
		$this->mdata['sort_subject'] = $this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'] . '&sort=subject' . $url, 'SSL');
		$this->mdata['sort_to'] = $this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'] . '&sort=to' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		$this->mdata['pagination'] = $pagination->render();
		...
		$this->mdata['add'] = $this->url->link('module/pavnewsletter/contact', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->mdata['repair'] = $this->url->link('module/pavnewsletter/draft_contact', 'token=' . $this->session->data['token'] . $url, 'SSL');

		// LOAD TEMPLATE
		$template = 'module/pavnewsletter/draft_contact.tpl';
		$this->_render($template);
	}
	...
	public function contact(){
		...
		$this->mdata['url_draft'] = $this->url->link('module/pavnewsletter/ajaxdraft', 'token=' . $this->session->data['token'], 'SSL');
		$this->mdata['url_send'] = $this->url->link('module/pavnewsletter/ajaxsend', 'token=' . $this->session->data['token'], 'SSL');
		...
		// LOAD TEMPLATE
		$template = 'module/pavnewsletter/contact.tpl';
		$this->_render($template);
	}
