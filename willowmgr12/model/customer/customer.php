...
class ModelCustomerCustomer extends Model {
	...
	//Bonk04
/*	public function getTotalTransactionsByOrderId2($order_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_transaction WHERE order_id = '" . (int)$order_id . "' AND amount > 0");
