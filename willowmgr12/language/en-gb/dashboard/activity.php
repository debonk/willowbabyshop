...
$_['text_customer_google_login']	= '<a href="customer_id=%d">%s</a> logged in with Google Account.';
...
$_['text_customer_google_register']	= '<a href="customer_id=%d">%s</a> registered with Google Account.';
