...
$_['entry_api_product']               = 'API Product Update';
...
$_['help_api_product']                = 'For auto update purpose. This API doesn\'t do IP Check. Only use if 3rd party update app has dynamic IP.';
