          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($city['city'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $city['city']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $city['city']; ?>" />
                    <?php } ?></td>
