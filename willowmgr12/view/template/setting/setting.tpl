          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-api-product"><span data-toggle="tooltip" title="<?= $help_api_product; ?>"><?= $entry_api_product; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_api_product_id" id="input-api-product" class="form-control">
                      <option value="0"><?= $text_none; ?></option>
                      <?php foreach ($apis as $api) { ?>
                      <?php if ($api['api_id'] == $config_api_product_id) { ?>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?= $help_account_mail; ?>"><?= $entry_account_mail; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?= $help_order_mail; ?>"><?= $entry_order_mail; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?= $help_affiliate_mail; ?>"><?= $entry_affiliate_mail; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-alert-email"><span data-toggle="tooltip" title="<?= $help_mail_alert; ?>"><?= $entry_mail_alert; ?></span></label>
                <div class="col-sm-10">
                  <textarea name="config_mail_alert" rows="5" placeholder="<?= $entry_mail_alert; ?>" id="input-alert-email" class="form-control"><?= $config_mail_alert; ?></textarea>
                </div>
              </div>
            </div>
