<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $tool; ?>"><?php echo $text_tools; ?></a></li>
    </ul>
  </li>
...
<!--Bonk04-->
<!--	  <li><a href="<?php //echo $cashback; ?>"><?php //echo $text_cashback; ?></a></li>
    ...
    <ul>
      <li><a class="parent"><?php echo $text_sale; ?></a>
        <ul>
		  ...
		  <!--Bonk04-->
          <li><a href="<?php echo $report_sale_cashback; ?>"><?php echo $text_report_sale_cashback; ?></a></li>
        </ul>
      </li>
