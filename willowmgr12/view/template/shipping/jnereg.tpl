  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-jnereg" onclick="$('#form').submit();" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
        ...
        <div class="tab-content" >
          <div id="tab-general" class="tab-pane active">
            ...
            <div class="panel-body">
                ...
                <select name="jnereg_tax_class_id" class="form-control">
                    <option value="0"><?php echo $text_none; ?></option>
                    <?php foreach ($tax_classes as $tax_class) { ?>
                    <?php if ($tax_class['tax_class_id'] == $jnereg_tax_class_id) { ?>
                ...
                <select name="jnereg_status" class="form-control">
                ...
                <input class="form-control" type="text" name="jnereg_sort_order" value="<?php echo $jnereg_sort_order; ?>" size="1" />
          </div></div>
          </div>
          ...
          <div id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>" class="tab-pane">
            ...
            <div class="panel-body">
                ...
                <textarea class="form-control" name="jnereg_<?php echo $geo_zone['geo_zone_id']; ?>_rate" cols="40" rows="5"><?php echo ${'jnereg_' . $geo_zone['geo_zone_id'] . '_rate'}; ?></textarea>
              
                <label class="control-label"><?php echo $entry_status; ?></label>
                <select class="form-control" name="jnereg_<?php echo $geo_zone['geo_zone_id']; ?>_status">
                    <?php if (${'jnereg_' . $geo_zone['geo_zone_id'] . '_status'}) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
