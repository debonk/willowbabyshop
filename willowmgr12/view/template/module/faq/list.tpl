          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($topic['faq_id'], $selected)) { ?>
                  ...
                  <td class="text-left"><?php echo $topic['status']; ?></td>
                  <td class="text-right"><?php echo $topic['sort_order']; ?></td>
                  <td class="text-right"><a href="<?php echo $topic['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
