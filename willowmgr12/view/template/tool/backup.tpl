  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-backup" data-toggle="tooltip" title="<?php echo $button_export; ?>" class="btn btn-default"><i class="fa fa-upload"></i></button>
        <button type="submit" form="form-restore" data-toggle="tooltip" title="<?php echo $button_import; ?>" class="btn btn-default"><i class="fa fa-download"></i></button>
      </div>
        ...
        <form action="<?php echo $backup; ?>" method="post" enctype="multipart/form-data" id="form-backup" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
			  ...
			  <!--Bonk-->
            <label class="col-sm-2 control-label" for="csv-format"><span data-toggle="tooltip" title="<?php echo $help_csv; ?>"><?php echo $csv_format; ?></label>
            <div class="col-sm-10">
			  <input type="checkbox" name="csv" id="csv-format" checked="checked"/>
			</div>
