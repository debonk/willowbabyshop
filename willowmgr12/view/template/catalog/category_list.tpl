            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'product_total') { ?>
                    <a href="<?= $sort_product_total; ?>" class="<?= strtolower($order); ?>"><?= $column_product_total; ?></a>
                    <?php } else { ?>
                    <a href="<?= $sort_product_total; ?>"><?= $column_product_total; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?= $category['product_total']; ?></td>
