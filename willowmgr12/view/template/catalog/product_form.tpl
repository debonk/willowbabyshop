...
<div id="content">
					...
					<div class="tab-content">
						<div class="tab-pane" id="tab-general">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="language<?= $language['language_id']; ?>">
									<div class="form-group required">
										...
										<div class="col-sm-10">
											<input type="text" name="product_description[<?= $language['language_id']; ?>][name]"
												value="<?= isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>"
												placeholder="<?= $entry_name; ?>" id="input-name<?= $language['language_id']; ?>"
												class="form-control" />
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="product_description[<?= $language['language_id']; ?>][description]"
												...
												class="form-control summernote"><?= isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
										</div>
									</div>
									<div class="form-group required">
										...
										<div class="col-sm-10">
											<input type="text" name="product_description[<?= $language['language_id']; ?>][meta_title]"
												value="<?= isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title'] : ''; ?>"
												placeholder="<?= $entry_meta_title; ?>" id="input-meta-title<?= $language['language_id']; ?>"
												class="form-control" />
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-meta-description<?= $language['language_id']; ?>">
										...
										<div class="col-sm-10">
											<textarea name="product_description[<?= $language['language_id']; ?>][meta_description]" rows="5"
												...
												class="form-control"><?= isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-meta-keyword<?= $language['language_id']; ?>">
											<?= $entry_meta_keyword; ?>
										</label>
										<div class="col-sm-10">
											<textarea name="product_description[<?= $language['language_id']; ?>][meta_keyword]" rows="5"
												...
												class="form-control"><?= isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-tag<?= $language['language_id']; ?>"><span
												data-toggle="tooltip" title="<?= $help_tag; ?>">
												<?= $entry_tag; ?>
											</span></label>
										<div class="col-sm-10">
											<input type="text" name="product_description[<?= $language['language_id']; ?>][tag]"
												value="<?= isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>"
												placeholder="<?= $entry_tag; ?>" id="input-tag<?= $language['language_id']; ?>"
												class="form-control" />
										</div>
									</div>
								</div>
						...
						<div class="tab-pane" id="tab-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="sku" value="<?= $sku; ?>" placeholder="<?= $entry_sku; ?>" id="input-sku"
										class="form-control" />
									<?php if ($error_sku) { ?>
									<div class="text-danger">
										<?= $error_sku; ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="stock_status_id" id="input-stock-status" class="form-control">
										...
										<option value="<?= $stock_status['stock_status_id']; ?>" selected="selected">
											<?= $stock_status['name']; ?>
										</option>
										<?php } else { ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="keyword" value="<?= $keyword; ?>" placeholder="<?= $entry_keyword; ?>"
						...
						<div class="tab-pane" id="tab-links">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-manufacturer"><span data-toggle="tooltip"
										title="<?= $help_manufacturer; ?>">
										<?= $entry_manufacturer; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="manufacturer" value="<?= $manufacturer ?>"
										placeholder="<?= $entry_manufacturer; ?>" id="input-manufacturer" class="form-control" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="category" value="" placeholder="<?= $entry_category; ?>" id="input-category"
										class="form-control" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="filter" value="" placeholder="<?= $entry_filter; ?>" id="input-filter"
										class="form-control" />
									<div id="product-filter" class="well well-sm" style="height: 150px; overflow: auto;">
										<?php foreach ($product_filters as $product_filter) { ?>
										<div id="product-filter<?= $product_filter['filter_id']; ?>"><i class="fa fa-minus-circle"></i>
											<?= $product_filter['name']; ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="download" value="" placeholder="<?= $entry_download; ?>" id="input-download"
										class="form-control" />
									<div id="product-download" class="well well-sm" style="height: 150px; overflow: auto;">
										<?php foreach ($product_downloads as $product_download) { ?>
										<div id="product-download<?= $product_download['download_id']; ?>"><i
												class="fa fa-minus-circle"></i>
											<?= $product_download['name']; ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="related" value="" placeholder="<?= $entry_related; ?>" id="input-related"
										class="form-control" />
							...
							<div class="table-responsive">
								<table id="attribute" class="table table-striped table-bordered table-hover">
											...
											<td class="text-left">
												...
												<div class="input-group"><span class="input-group-addon"><img
													...
													<textarea
														...
														class="form-control"><?= isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
												</div>
												<?php } ?>
											</td>
											<td class="text-left"><button type="button"
													onclick="$('#attribute-row<?= $attribute_row; ?>').remove();" data-toggle="tooltip"
													title="<?= $button_remove; ?>" class="btn btn-danger"><i
									...
									<tfoot>
										<tr>
											<td colspan="2"></td>
											<td class="text-left"><button type="button" onclick="addAttribute();" data-toggle="tooltip"
							...
							<div class="row">
								<div class="col-sm-2">
									<ul class="nav nav-pills nav-stacked" id="option">
										...
										<li><a href="#tab-option<?= $option_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle"
													onclick="$('a[href=\'#tab-option<?= $option_row; ?>\']').parent().remove(); $('#tab-option<?= $option_row; ?>').remove(); $('#option a:first').tab('show');"></i>
												<?= $product_option['name']; ?>
											</a></li>
										<?php $option_row++; ?>
										<?php } ?>
										<li>
											<input type="text" name="option" value="" placeholder="<?= $entry_option; ?>" id="input-option"
												class="form-control" />
										</li>
									</ul>
								</div>
								<div class="col-sm-10">
									<div class="tab-content">
										...
										<div class="tab-pane" id="tab-option<?= $option_row; ?>">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-required<?= $option_row; ?>">
													<?= $entry_required; ?>
												</label>
												<div class="col-sm-10">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-value<?= $option_row; ?>">
													<?= $entry_option_value; ?>
												</label>
												<div class="col-sm-10">
													<input type="text" name="product_option[<?= $option_row; ?>][value]"
														value="<?= $product_option['value']; ?>" placeholder="<?= $entry_option_value; ?>"
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<textarea name="product_option[<?= $option_row; ?>][value]" rows="5"
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<div class="input-group date">
														<input type="text" name="product_option[<?= $option_row; ?>][value]"
															value="<?= $product_option['value']; ?>" placeholder="<?= $entry_option_value; ?>"
															data-date-format="YYYY-MM-DD" id="input-value<?= $option_row; ?>" class="form-control" />
														<span class="input-group-btn">
															<button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
														</span>
													</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group time">
														<input type="text" name="product_option[<?= $option_row; ?>][value]"
															value="<?= $product_option['value']; ?>" placeholder="<?= $entry_option_value; ?>"
															data-date-format="HH:mm" id="input-value<?= $option_row; ?>" class="form-control" />
														<span class="input-group-btn">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="input-group datetime">
														<input type="text" name="product_option[<?= $option_row; ?>][value]"
															value="<?= $product_option['value']; ?>" placeholder="<?= $entry_option_value; ?>"
															data-date-format="YYYY-MM-DD HH:mm" id="input-value<?= $option_row; ?>"
															class="form-control" />
														<span class="input-group-btn">
															<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
														</span>
						...
						<div class="tab-pane" id="tab-recurring">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<?php foreach ($product_recurrings as $recurring_row => $product_recurring) { ?>
										<tr id="recurring-row<?= $recurring_row; ?>">
											<td class="text-left"><select name="product_recurring[<?= $recurring_row; ?>][recurring_id]"
													class="form-control">
													<?php foreach ($recurrings as $recurring) { ?>
													<?php if ($recurring['recurring_id'] == $product_recurring['recurring_id']) { ?>
													<option value="<?= $recurring['recurring_id']; ?>" selected="selected">
														<?= $recurring['name']; ?>
													</option>
													<?php } else { ?>
											...
											<td class="text-left"><select name="product_recurring[<?= $recurring_row; ?>][customer_group_id]"
													class="form-control">
											...
											<td class="text-right"><button type="button"
													onclick="$('#recurring-row<?= $recurring_row; ?>').remove()" data-toggle="tooltip"
													title="<?= $button_remove; ?>" class="btn btn-danger"><i
														class="fa fa-minus-circle"></i></button></td>
										</tr>
										<?php } ?>
									...
									<tfoot>
										<tr>
											<td colspan="2"></td>
											<td class="text-right"><button type="button" onclick="addRecurring()" data-toggle="tooltip"
								...
								<table id="discount" class="table table-striped table-bordered table-hover text-left">
									...
									<tbody>
										...
										<tr id="discount-row<?= $discount_row; ?>">
											<td><select name="product_discount[<?= $discount_row; ?>][customer_group_id]"
													class="form-control">
													<?php foreach ($customer_groups as $customer_group) { ?>
											...
											<td class="text-right"><input type="text" name="product_discount[<?= $discount_row; ?>][quantity]"
													value="<?= $product_discount['quantity']; ?>" placeholder="<?= $entry_quantity; ?>"
											...
											<td class="text-right"><button type="button"
													onclick="$('#discount-row<?= $discount_row; ?>').remove();" data-toggle="tooltip"
													title="<?= $button_remove; ?>" class="btn btn-danger"><i
														class="fa fa-minus-circle"></i></button></td>
										</tr>
										<?php } ?>
								...
								<table id="special" class="table table-striped table-bordered table-hover text-left">
									...
									<tbody>
										...
										<tr id="special-row<?= $special_row; ?>">
											...
											<td class="text-right"><button type="button"
													onclick="$('#special-row<?= $special_row; ?>').remove();" data-toggle="tooltip"
													title="<?= $button_remove; ?>" class="btn btn-danger"><i
														class="fa fa-minus-circle"></i></button></td>
										</tr>
										<?php } ?>
									...
									<tbody>
										...
										<tr id="image-row<?= $image_row; ?>">
											...
											<td class="text-right"><input type="text" name="product_image[<?= $image_row; ?>][sort_order]"
													...
													class="form-control" /></td>
											<td class="text-left"><button type="button" onclick="$('#image-row<?= $image_row; ?>').remove();"
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right"><input type="text"
													...
													value="<?= isset($product_reward[$customer_group['customer_group_id']]) ? $product_reward[$customer_group['customer_group_id']]['points'] : ''; ?>"
													class="form-control" /></td>
										</tr>
										<?php } ?>
									</tbody>
								...
								<table class="table table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-left"><select name="product_layout[<?= $store['store_id']; ?>]"
													class="form-control">
													<option value=""></option>
													<?php foreach ($layouts as $layout) { ?>
	...
	<script type="text/javascript">
		let discount_row = '<?= $product_discount_count; ?>';
		...
		function addDiscount() {
			...
			html += '  <td><div class="input-group date"><input type="text" name="product_discount[' + discount_row + '][date_start]" value="" placeholder="<?= $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
			html += '  <td><div class="input-group date"><input type="text" name="product_discount[' + discount_row + '][date_end]" value="" placeholder="<?= $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
			html += '  <td class="text-right"><button type="button" onclick="$(\'#discount-row' + discount_row + '\').remove();" data-toggle="tooltip" title="<?= $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
			html += '</tr>';
	...
	<script type="text/javascript">
		let special_row = '<?= $product_special_count; ?>';
