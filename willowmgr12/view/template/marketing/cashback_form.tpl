          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-prefix-code"><?php echo $entry_prefix_code; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="prefix_code" value="<?php echo $prefix_code; ?>" placeholder="<?php echo $entry_prefix_code; ?>" id="input-prefix-code" class="form-control" />
                  <?php if ($error_prefix_code) { ?>
                  <div class="text-danger"><?php echo $error_prefix_code; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_transferable; ?>"><?php echo $entry_transferable; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($transferable) { ?>
                    <input type="radio" name="transferable" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="transferable" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$transferable) { ?>
                    <input type="radio" name="transferable" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="transferable" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
