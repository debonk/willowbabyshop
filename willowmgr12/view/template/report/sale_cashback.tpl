...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $report; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_report_print; ?>" class="btn btn-info"><i class="fa fa-print"></i></a></div>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/sale_cashback&token=<?php echo $token; ?>';
