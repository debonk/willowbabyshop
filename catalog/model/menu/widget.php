...
class ModelMenuWidget extends Model {
	...
	protected function getLayout( $layout ){
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/template/module/pavmegamenu/widgets/'.$layout.'.tpl')) {
			$template = DIR_TEMPLATE. $this->config->get('theme_default_directory') . '/template/module/pavmegamenu/widgets/'.$layout.'.tpl';
		} else {
			$template = DIR_TEMPLATE.'default/template/module/widgets/'.$layout.'.tpl';
		}
		return $template;
	}
