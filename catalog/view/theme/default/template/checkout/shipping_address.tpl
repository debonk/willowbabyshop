<form class="form-horizontal">
  ...
  <div id="shipping-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city_name']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city_name']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option> 
      <?php } ?>
      <?php } ?>
    </select>
  </div>
...
*/
			...
			$('#collapse-shipping-address select[name=\'city\']').load('index.php?route=account/address/city&zone_id=' + $('#collapse-shipping-address select[name=\'zone_id\']').val() + '&city=<?php echo $city; ?>'); // Bonk
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
