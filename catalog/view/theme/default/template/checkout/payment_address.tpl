<form class="form-horizontal">
  ...
  <div id="payment-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city_name']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option> <!-- Bonk -->
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city_name']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option> <!-- Bonk -->
      <?php } ?>
      <?php } ?>
    </select>
  </div>
...
*/
			...
			$('#collapse-payment-address select[name=\'city\']').load('index.php?route=account/address/city&zone_id=' + $('#collapse-payment-address select[name=\'zone_id\']').val() +'&city=<?php echo $city; ?>'); // Bonk
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
		...
		success: function(json) {
			...
			if (json['city'] && json['city'] != '') {
				for (i = 0; i < json['city'].length; i++) {
					...
					if (json['city'][i]['city'] == '<?php echo $city; ?>') {
						html += ' selected="selected"';
					}
