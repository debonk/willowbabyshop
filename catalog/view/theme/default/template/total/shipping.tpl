...
$('#button-quote').on('click', function() {
	$.ajax({
		...
		type: 'post',
		data: 'country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&city=' + $('select[name=\'city\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),
		dataType: 'json',
		beforeSend: function() {
...
*/
			...
			$('select[name=\'city\']').load('index.php?route=account/address/city&zone_id=' + $('select[name=\'zone_id\']').val() + '&city=<?php echo $city; ?>'); // Bonk
		},
...
$('select[name=\'zone_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=total/shipping/zone&zone_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
