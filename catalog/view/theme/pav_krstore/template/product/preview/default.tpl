...
<div class="image-container thumbnails <?php echo $class; ?>">
    <?php if ($thumb) { ?>
    <div class="image thumbnail space-10">
        ...
        <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="imagezoom">
            <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"  data-zoom-image="<?php echo $popup; ?>" class="product-image-zoom img-responsive"/><!--Bonk:defer image-->
        </a>
    </div>
    <?php } ?>  
