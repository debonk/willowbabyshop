      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td class="text-center">
				<div class="action u-action"> <!-- Bonk: This Div, cart, wishlist, and remove button -->
					<div class="cart">
						<button class="btn-action" type="button" data-toggle="tooltip" data-placement="top" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i></button>
					</div>
					<div class="wishlist">
						<button class="btn-action" type="button" data-toggle="tooltip" data-placement="top" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o"></i></button> 
					</div>
					<div class="remove">
						<a href="<?php echo $product['remove']; ?>"><button class="btn-action btn-remove" type="button" data-toggle="tooltip" data-placement="top" title="<?php echo $button_remove; ?>"><i class="fa fa-times"></i></button></a>
					</div>
				</div>
			</td>
          <?php } ?>
